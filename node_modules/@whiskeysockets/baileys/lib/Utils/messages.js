...
const generateWAMessageFromContent = (jid, message, options) => {
    var _a, _b;
    if ((_b = (_a = message === null || message === void 0 ? void 0 : message.viewOnceMessage) === null || _a === void 0 ? void 0 : _a.message) === null || _b === void 0 ? void 0 : _b.interactiveMessage) {
        message = message.viewOnceMessage.message;
    }
    if ((_b = (_a = message === null || message === void 0 ? void 0 : message.viewOnceMessage) === null || _a === void 0 ? void 0 : _a.message) === null || _b === void 0 ? void 0 : _b.buttonsMessage) {
        message = {
            ephemeralMessage: message.viewOnceMessage
        }
    }
